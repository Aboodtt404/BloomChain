...
import { idlFactory } from './bloomchain_backend.did.js';
export { idlFactory } from './bloomchain_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_BLOOMCHAIN_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./bloomchain_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the bloomchain_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./bloomchain_backend.did.js")._SERVICE>}
 */
export const bloomchain_backend = createActor(canisterId);
