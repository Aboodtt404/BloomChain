...
import { idlFactory } from './bloomchain_frontend.did.js';
export { idlFactory } from './bloomchain_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_BLOOMCHAIN_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./bloomchain_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the bloomchain_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./bloomchain_frontend.did.js")._SERVICE>}
 */
export const bloomchain_frontend = createActor(canisterId);
